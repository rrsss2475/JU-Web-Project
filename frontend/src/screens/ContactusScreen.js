...
const ContactusScreen = () => {
    return (
		...
		<div class="row">
			<div class="col-lg-5">
				<h2 style={{fontWeight:'700'}}>LIVE SUPPORT</h2>
			...
			<div class="col-lg-2">
				<img src="https://raw.githubusercontent.com/SouravSaha1999/Mobile-o-Mania/master/ls.jpg" class="img-responsive" alt=""/>
			</div>
		</div>

		<div class="row">
			<div class="col-lg-8">
				<h2 style={{marginBottom:'20px' , fontWeight:'700'}}>CONTACT US</h2>
				<form>
					<div class="form-group">
						<label style={{fontWeight:'500'}} class="contact-us-label" for="name">Name :</label>
						<input type="text" name="name" class="form-control"/>
					</div>

					<div class="form-group">
						<label style={{fontWeight:'500'}} for="email">Email :</label>
						<input type="email" name="email" class="form-control"/>
					</div>

					<div class="form-group">
						<label style={{fontWeight:'500'}} for="msg">Message :</label>
						<textarea name="msg" class="form-control"></textarea>
					</div>

					<button style={{marginTop:'10px' , fontWeight:'500'}} type="button" class="btn btn-primary">Submit</button>
				</form>
			</div>

			<div style={{marginTop:'70px'}} class="col-lg-4">
				<h2 style={{marginBottom:'20px' , fontWeight:'700'}}>Company Information :</h2>
