							...
							<ListGroup variant="flush">
								<ListGroup.Item>
									<Row style={{ fontFamily: "Rubik, sans-serif" }}>
										...
										<Col>
											<Link
												to={`/services/${booking.bookingItem.service.category.name}/${booking.bookingItem.service.subCategory.name}/${booking.bookingItem.service._id}`}
												style={{
													textDecoration: "none",
													color: "black",
												}}
											>
												{booking.bookingItem.name}
											</Link>
										</Col>
										<Col md={4}>
